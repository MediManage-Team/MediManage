...
public class MainShellController implements ViewSwitcher {
    ...
    private void applyTheme(org.example.MediManage.model.UserRole role) {
        try {
            ...
            String commonCssUrl = Objects.requireNonNull(getClass().getResource("/org/example/MediManage/css/common.css")).toExternalForm();
    ...
    private void handleLogout() {
        ...
        try {
            ...
            FXMLLoader loader = new FXMLLoader(
                    Objects.requireNonNull(getClass().getResource("/org/example/MediManage/login-view.fxml")));
            ...
            loginScene.getStylesheets().add(
                    Objects.requireNonNull(getClass().getResource("/org/example/MediManage/css/common.css")).toExternalForm());

...
CREATE TABLE IF NOT EXISTS anomaly_action_tracker (
    ...
    CHECK (closure_status IN ('OPEN', 'IN_PROGRESS', 'CLOSED')),
...
ON ai_prompt_registry(prompt_key, is_active, version_number DESC);
CREATE INDEX IF NOT EXISTS idx_ai_prompt_registry_history
ON ai_prompt_registry(prompt_key, version_number DESC);
...
CREATE TABLE IF NOT EXISTS subscription_weekly_summary (
    ...
    gross_amount_before_discount REAL NOT NULL DEFAULT 0.0,
    net_billed_amount REAL NOT NULL DEFAULT 0.0,
    total_savings REAL NOT NULL DEFAULT 0.0,
    leakage_percent REAL NOT NULL DEFAULT 0.0,
...
CREATE TABLE IF NOT EXISTS subscription_weekly_plan_summary (
    ...
    net_billed_amount REAL NOT NULL DEFAULT 0.0,
    total_savings REAL NOT NULL DEFAULT 0.0,
    average_savings_per_bill REAL NOT NULL DEFAULT 0.0,
    leakage_percent REAL NOT NULL DEFAULT 0.0,
    generated_at TEXT NOT NULL DEFAULT CURRENT_TIMESTAMP,

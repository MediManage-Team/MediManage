...
class PythonAIClientRegressionTest {
    ...
    void chatReturnsResponseFieldFromPythonEngine() throws Exception {
        ...
        PythonAIClient service = new PythonAIClient(false);
    ...
    private void startServer() throws IOException {
        try {
            ...
            throw new TestAbortedException("Port 5000 is already in use; skipping PythonAIClient contract test.", ex);
        }
    }
